package com.aztrex.procgenjs.modules.serviceModules.datafolder.model;
...
@Getter
@Setter
public class DataFolderUIListItem {
    private Long id;
    // private String wsid;
    ...
    // Constructors
    public DataFolderUIListItem() {
    }

    public DataFolderUIListItem(WorkspaceRecord workspaceRecord) {
    }

    public DataFolderUIListItem(String title, String path, String category, String group, String description,
    ...
    public DataFolderUIListItem(Map<String, Object> row) {
